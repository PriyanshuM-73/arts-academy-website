  ...
  return (
    ...
    <main className="min-h-screen bg-cyan-200 pt-36 pb-20 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Contact Card */}
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm border border-white/50 p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 border-b md:border-b-0 md:border-r border-gray-100 pb-8 md:pb-0 md:pr-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-1">
                  ...
                  <a href="mailto:srisiddhiacademy@gmail.com" className="text-lg font-bold text-gray-900 hover:text-amber-700 transition break-all">
            ...
            <div className="flex flex-col">
              ...
              {/* Address 1: Classes */}
              <div className="mb-6">
                <p className="text-xs font-bold text-gray-400 uppercase mb-1">Classes</p>
                <Link 

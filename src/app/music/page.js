...
export default function MusicPage() {
  ...
  return (
    <main className="min-h-screen bg-[#7B3F00]/75 pt-36 pb-20 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-3xl shadow-sm border border-white/50 mb-12">
          ...
          <div className="bg-amber-50/90 border border-amber-100 p-6 md:p-8 rounded-2xl mb-10">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-x-4 gap-y-6">
               ...
               <div className="text-gray-700 leading-relaxed">
                 This is the starting level where students learn the basics of classical music. It covers simple raags, alankars, and basic rhythms.
               </div>
               <div className="text-gray-900 font-bold flex items-start gap-2 whitespace-nowrap">
                 <span className="text-amber-700">•</span> Bhusan (1st, 2nd and 3rd year):
               </div>
               <div className="text-gray-700 leading-relaxed">
                 Bhushan is an intermediate stage that adds more depth to your learning. Students explore a wider variety of raags and start focusing on performance details.
               </div>
               <div className="text-gray-900 font-bold flex items-start gap-2 whitespace-nowrap">
                 <span className="text-amber-700">•</span> Visharad I & II(4th and 5th year):
               </div>
               <div className="text-gray-700 leading-relaxed">
                 Visharad is the advanced level where students work toward true mastery. It involves learning complex raags and detailed theory.
               </div>
             </div>
          </div>
            ...
            >
               {extendedPhotos.map((photo, index) => (
                 <div key={index} className="w-(--slide-width) shrink-0 px-2">
                   <img src={photo} className="w-full h-64 md:h-72 object-cover rounded-lg shadow-sm" alt="Class snapshot" />
                 </div>
               ))}
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-12 md:gap-20 max-w-5xl mx-auto py-12">
          ...
          <div className="flex flex-col items-center md:items-start w-full md:w-1/3">
            <div className="w-56 aspect-3/4 overflow-hidden border-4 border-amber-50 shadow-md rounded-lg mb-6">
              <img src="/Mt.JPG" alt="Teacher" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="flex-1 w-full flex justify-center md:justify-end items-center mt-8 md:mt-0 relative z-0">
            <div className="w-64 md:w-80 rotate-3 hover:rotate-0 transition-transform duration-500 ease-out cursor-pointer">
              <img src="/Mst.jpeg" alt="Instrument Sticker" className="w-full h-auto drop-shadow-xl" />
            </div>
          </div>
